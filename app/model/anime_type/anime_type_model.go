...
// arModel is a active record design model for table animeType operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of animeType.
	Table = "animeType"
	// Model is the model object of animeType.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table animeType.
	Columns = struct {
		Id    string // 动漫类型ID  
        Type  string // 动漫类型
	}{
