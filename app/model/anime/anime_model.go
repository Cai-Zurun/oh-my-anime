...
// arModel is a active record design model for table anime operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of anime.
	Table = "anime"
	// Model is the model object of anime.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table anime.
	Columns = struct {
		Id          string //                    
        Name        string // 名字               
        Link        string //                    
